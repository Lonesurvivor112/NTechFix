...
Write-Host "Report is in c:\users\jdoe\downloads\Get-MFAReport-ActiveUsers.csv"
...
$Report | Sort-Object UserPrincipalName | Export-CSV -Encoding UTF8 -NoTypeInformation c:\users\jdoe\downloads\Get-MFAReport-ActiveUsers.csv