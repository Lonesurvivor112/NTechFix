...
[CmdletBinding()]
Param (
    [string]$SearchBase = "OU=Computers,OU=Contoso Corp,DC=contoso,DC=com"
)
...
$ReportPath = Join-Path (Split-Path $MyInvocation.MyCommand.Path) -ChildPath "C:\WorkstationsWithBitLocker.csv"
